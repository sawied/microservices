This program runs in mysql 8 above version.
...
``` sh
storm jar target/microservice-screen-1.0-SNAPSHOT.jar com.github.sawied.CrawlTopology -conf crawler-conf.yaml -local
```
...
``` sh
storm jar target/microservice-screen-1.0-SNAPSHOT.jar  org.apache.storm.flux.Flux --local crawler.flux --sleep 86400000
```
